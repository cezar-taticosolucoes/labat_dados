...
# Dados da API Sienge
url_api_base = 'https://api.sienge.com.br/labat/public/api/bulk-data/v1/bank-movement'
...
max_retries = 3
retry_delay = 300  # Delay de 5 minutos entre as tentativas
...
if data:
    save_json(data, 'files/mov_bancarias.json')  # Salva o JSON no arquivo